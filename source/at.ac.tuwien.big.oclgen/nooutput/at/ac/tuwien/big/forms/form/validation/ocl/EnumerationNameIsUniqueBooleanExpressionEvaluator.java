...
public class EnumerationNameIsUniqueBooleanExpressionEvaluator implements at.ac.tuwien.big.oclgen.OCLBooleanExpressionEvaluator<Enumeration> {
	
	public static final at.ac.tuwien.big.oclgen.OCLBooleanExpressionEvaluator<Enumeration> INSTANCE = new EnumerationNameIsUniqueBooleanExpressionEvaluator();
...
final java.util.Set<at.ac.tuwien.big.forms.Enumeration> var0 =  (java.util.Set) extents.get(ePackage.getEClassifier("Enumeration"));
final java.util.Collection<at.ac.tuwien.big.forms.Enumeration> var1 = at.ac.tuwien.big.oclgen.OCL2JavaSupport.select(var0, var2 -> {
...
final java.util.Collection<at.ac.tuwien.big.forms.Enumeration> var6 = org.eclipse.ocl.util.CollectionUtil.excluding(var1, self);
