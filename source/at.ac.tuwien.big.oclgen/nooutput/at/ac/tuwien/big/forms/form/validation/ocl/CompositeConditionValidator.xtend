...
public class CompositeConditionValidator extends org.eclipse.xtext.validation.AbstractDeclarativeValidator {
	...
	public static final String COMPOSEDCONDITIONTYPESAREEQUAL_ISSUE_KEY = "ComposedConditionTypesAreEqualError";
	private static final at.ac.tuwien.big.oclgen.OCLBooleanExpressionEvaluator<CompositeCondition> evaluatorComposedConditionTypesAreEqual = at.ac.tuwien.big.forms.form.validation.ocl.ComposedConditionTypesAreEqualBooleanExpressionEvaluator.INSTANCE;
	
	@Check
	def void checkComposedConditionTypesAreEqual(CompositeCondition o) {
		if (!evaluatorComposedConditionTypesAreEqual.isValid(o)) {
			val EStructuralFeature feature = evaluatorComposedConditionTypesAreEqual.findErrorFeature(o);
			...
			error("The OCL-Expression named 'ComposedConditionTypesAreEqual' evaluated to false!", feature, COMPOSEDCONDITIONTYPESAREEQUAL_ISSUE_KEY, userData.toArray(newArrayOfSize(userData.size())));
		}
	}
}