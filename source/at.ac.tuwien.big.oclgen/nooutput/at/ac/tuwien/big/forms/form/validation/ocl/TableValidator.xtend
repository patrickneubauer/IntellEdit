...
public class TableValidator extends org.eclipse.xtext.validation.AbstractDeclarativeValidator {
	...
	public static final String TABLECOLUMNREFERSTOTARGETENTITYFEATURE_ISSUE_KEY = "TableColumnRefersToTargetEntityFeatureError";
	private static final at.ac.tuwien.big.oclgen.OCLBooleanExpressionEvaluator<Table> evaluatorTableColumnRefersToTargetEntityFeature = at.ac.tuwien.big.forms.form.validation.ocl.TableColumnRefersToTargetEntityFeatureBooleanExpressionEvaluator.INSTANCE;
	
	@Check
	def void checkTableColumnRefersToTargetEntityFeature(Table o) {
		if (!evaluatorTableColumnRefersToTargetEntityFeature.isValid(o)) {
			val EStructuralFeature feature = evaluatorTableColumnRefersToTargetEntityFeature.findErrorFeature(o);
			...
			error("The OCL-Expression named 'TableColumnRefersToTargetEntityFeature' evaluated to false!", feature, TABLECOLUMNREFERSTOTARGETENTITYFEATURE_ISSUE_KEY, userData.toArray(newArrayOfSize(userData.size())));
		}
	}
}