...
public class AttributeValidator extends org.eclipse.xtext.validation.AbstractDeclarativeValidator {
	...
	public static final String ATTRIBUTETYPEISVALID_ISSUE_KEY = "AttributeTypeIsValidError";
	private static final at.ac.tuwien.big.oclgen.OCLBooleanExpressionEvaluator<Attribute> evaluatorAttributeTypeIsValid = at.ac.tuwien.big.forms.form.validation.ocl.AttributeTypeIsValidBooleanExpressionEvaluator.INSTANCE;
	
	@Check
	def void checkAttributeTypeIsValid(Attribute o) {
		if (!evaluatorAttributeTypeIsValid.isValid(o)) {
			val EStructuralFeature feature = evaluatorAttributeTypeIsValid.findErrorFeature(o);
			...
			error("The OCL-Expression named 'AttributeTypeIsValid' evaluated to false!", feature, ATTRIBUTETYPEISVALID_ISSUE_KEY, userData.toArray(newArrayOfSize(userData.size())));
		}
	}
}