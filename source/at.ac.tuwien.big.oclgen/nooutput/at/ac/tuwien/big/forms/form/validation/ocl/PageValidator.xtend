...
public class PageValidator extends org.eclipse.xtext.validation.AbstractDeclarativeValidator {
	...
	public static final String FIRSTLETTERINPAGETITLEISUPPERCASE_ISSUE_KEY = "FirstLetterInPageTitleIsUpperCaseError";
	private static final at.ac.tuwien.big.oclgen.OCLBooleanExpressionEvaluator<Page> evaluatorFirstLetterInPageTitleIsUpperCase = at.ac.tuwien.big.forms.form.validation.ocl.FirstLetterInPageTitleIsUpperCaseBooleanExpressionEvaluator.INSTANCE;
	
	@Check
	def void checkFirstLetterInPageTitleIsUpperCase(Page o) {
		if (!evaluatorFirstLetterInPageTitleIsUpperCase.isValid(o)) {
			val EStructuralFeature feature = evaluatorFirstLetterInPageTitleIsUpperCase.findErrorFeature(o);
			...
			error("The OCL-Expression named 'FirstLetterInPageTitleIsUpperCase' evaluated to false!", feature, FIRSTLETTERINPAGETITLEISUPPERCASE_ISSUE_KEY, userData.toArray(newArrayOfSize(userData.size())));
		}
	}
}